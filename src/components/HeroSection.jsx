        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-6" ref={headlineRef}>
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="text-xs font-extrabold uppercase tracking-[0.24em] text-gb-primary">{copy.badge}</span>
            </div>
            <h1 className="text-[clamp(3rem,6vw,5.8rem)] font-black text-[#102c2a] tracking-[-0.06em] leading-[0.98]">
              ...
              <span className="block mt-3 text-[#102c2a]">{copy.madeSimple}</span>
            </h1>
            ...
            <div className="mt-8 flex flex-wrap gap-3 text-xs font-bold text-slate-600">
              <span className="rounded-full border border-[#c9dfd8] bg-white/70 px-4 py-2">{copy.fairFares}</span>
              <span className="rounded-full border border-[#c9dfd8] bg-white/70 px-4 py-2">{copy.verifiedDrivers}</span>
              <span className="rounded-full border border-[#c9dfd8] bg-white/70 px-4 py-2">{copy.districts}</span>
            </div>
          </div>
            ...
            <div className="relative w-full max-w-lg">
              ...
              <div className="relative overflow-hidden rounded-[2.25rem] border border-white/80 bg-white/50 shadow-[0_30px_80px_rgba(0,83,79,0.18)]">
                ...
                <div className="absolute bottom-5 left-5 right-5 flex items-center justify-between rounded-2xl bg-[#102c2a]/90 p-4 text-white backdrop-blur-md">
                  <div><p className="text-[10px] uppercase tracking-[0.2em] text-[#9ed6c6]">{copy.nextJourney}</p><p className="mt-1 text-sm font-bold">{copy.betterChoice}</p></div>
